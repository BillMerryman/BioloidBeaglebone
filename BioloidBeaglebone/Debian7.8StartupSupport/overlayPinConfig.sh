...
config-pin P8.39 pruin				#Bit 6 of byte feed
config-pin P8.40 pruin				#Bit 7 of byte feed
config-pin P8.41 pruin				#Bit 4 of byte feed
config-pin P8.42 pruin				#Bit 5 of byte feed
config-pin P8.43 pruin				#Bit 2 of byte feed
config-pin P8.44 pruin				#Bit 3 of byte feed
config-pin P8.45 pruin				#Bit 0 of byte feed
config-pin P8.46 pruin				#Bit 1 of byte feed
config-pin P8.34 pwm				#Pin to feed XCLK signal out to camera
...
echo 4 > /sys/class/pwm/export			#Enable configuration of P8.34 PWM
echo 62 > /sys/class/pwm/pwm4/period_ns		#Set P8.24 period
echo 31 > /sys/class/pwm/pwm4/duty_ns		#Set P8.24 duty cycle
echo 1 > /sys/class/pwm/pwm4/run		#Start P8.24 8Mhz clock signal
